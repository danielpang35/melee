...
Latest arm mesh, wrist and shoulder repair: [6 September arm repair](Docs/ARM_REPAIR.md). This includes visual limitations that the numerical combat checks do not detect.

Latest defaults, evidence and limitations: [Kinetic swing revision — 6 September 2026](Docs/KINETIC_SWING_PASS.md). The historical notes below describe earlier tuning passes.
...
- Strike release: 560 ms, with a 5â€“95% damage window (504 ms active).
...
## Citadel replacement â€” September 6, 2026 (latest)
...
## Hands and hip-pivot lean — 6 September 2026

See [HANDS_AND_LEAN.md](Docs/HANDS_AND_LEAN.md) for the exact scope, checkpoint hashes, evidence and limitations. UE 5.8 Editor Development build and final rig import succeeded. Sanitized native checks passed: 605 combat, 1,413,854 presentation, 1,073 swing and 46 movement. Final rendered motion passed 18/18 scenarios; the full in-engine tour passed 56/56 after correcting two outdated test fixtures. Engine automation passed 4/4 with no test warnings. Skinned surface audit: 72 captures / 144 arms, zero open boundaries, 0.000022 cm maximum rigid-fit error. Blade discrepancy: 0.000034 cm; arm edge ratio: 1.000255. The rear shoulder opening remains deferred in MEL-14; these results do not constitute final visual acceptance or a packaged performance claim.
